...
export function verifyLibraryInterchange(document, { nativeEdit = false } = {}) {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  console.log(JSON.stringify(verifyLibraryInterchange(document, { nativeEdit: process.argv.includes('--native-edit') })));
}
