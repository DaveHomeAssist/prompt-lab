// SAFETY: PATHS is a frozen, hardcoded map of static SVG markup strings.
// dangerouslySetInnerHTML is acceptable here because no user input ever enters this map.
const PATHS = {
  ...
  Keyboard: `<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M10 8h.01"/><path d="M12 8h.01"/><path d="M14 8h.01"/><path d="M10 12h.01"/><path d="M12 12h.01"/><path d="M14 12h.01"/><path d="M16 8h.01"/><path d="M8 8h.01"/><path d="M8 12h.01"/><path d="M16 12h.01"/><path d="M7 16h10"/>`,
  FlaskConical: `<path d="M14 2v6l3.36 5.6a1 1 0 0 1-.9 1.4H7.54a1 1 0 0 1-.9-1.4L10 8V2"/><path d="M6 2h12"/>`,
  ...
  BookmarkPlus: `<path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h6"/><path d="M17 3v6"/><path d="M14 6h6"/>`,
  Braces: `<path d="M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5c0 1.1.9 2 2 2h1"/><path d="M16 21h1a2 2 0 0 0 2-2v-5c0-1.1.9-2 2-2a2 2 0 0 1-2-2V5a2 2 0 0 0-2-2h-1"/>`,
  CircleAlert: `<circle cx="12" cy="12" r="10"/><path d="M12 8v4"/><path d="M12 16h.01"/>`,
  CopyPlus: `<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/><path d="M15 15h6"/><path d="M18 12v6"/>`,
  Eye: `<path d="M2.06 12.35a1 1 0 0 1 0-.7C3.62 7.76 7.4 5 12 5c4.6 0 8.38 2.76 9.94 6.65a1 1 0 0 1 0 .7C20.38 16.24 16.6 19 12 19c-4.6 0-8.38-2.76-9.94-6.65"/><circle cx="12" cy="12" r="3"/>`,
  FileText: `<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><polyline points="14 2 14 8 20 8"/><line x1="8" x2="16" y1="13" y2="13"/><line x1="8" x2="16" y1="17" y2="17"/>`,
  ...
  Pin: `<path d="M12 17v5"/><path d="M5 17h14"/><path d="M6 3h12l-2 8 3 3H5l3-3z"/>`,
  Quote: `<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2H4c-1.25 0-2 .75-2 1.97V9c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.75-2-2-2h-4c-1.25 0-2 .75-2 1.97V9c0 1.25.75 2 2 2h.75c0 4.25.25 4-1.75 4z"/>`,
  RefreshCw: `<path d="M21 12a9 9 0 0 0-15-6.7L3 8"/><path d="M3 3v5h5"/><path d="M3 12a9 9 0 0 0 15 6.7L21 16"/><path d="M16 16h5v5"/>`,
